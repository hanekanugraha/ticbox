    ...
    <g:form class="form-horizontal" action="updateRespondentProfile">
        ...
        <div style="padding: 20px; background-color: #eeeeed; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px;" >
            ...
            %{--<div class="form-group">--}%
                ...
                %{--<div class="col-sm-8">--}%
                    %{--<g:select name="profileItems_LM_BRANCH"--}%
                              %{--class="form-control" style="width: auto"--}%
                              %{--from="${LookupMaster.findByCode('LM_BRANCH')?.values}" optionKey="key" optionValue="value"--}%
                              %{--value="${respondentDetail?.profileItems['PI_BRANCH']}"--}%
                              %{--noSelection="['':'-Choose One-']" />--}%
                %{--</div>--}%
            %{--</div>--}%
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <g:select name="profileItems_LM_GENDER001"
                              class="form-control" style="width: auto"
                              from="${LookupMaster.findByCode('LM_GENDER001')?.values}" optionKey="key" optionValue="value"
                              value="${respondentDetail?.profileItems['PI_GENDER001']}"
                              noSelection="['':'-Choose One-']" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <g:select name="profileItems_LM_EDU001"
                              class="form-control" style="width: auto"
                              from="${LookupMaster.findByCode('LM_EDU001')?.values}" optionKey="key" optionValue="value"
                              value="${respondentDetail?.profileItems['PI_EDU001']}"
                              noSelection="['':'-Choose One-']" />
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <g:select name="profileItems_LM_CITY001"
                              class="form-control" style="width: auto"
                              from="${LookupMaster.findByCode('LM_CITY001')?.values}" optionKey="key" optionValue="value"
                              value="${respondentDetail?.profileItems['PI_CITY001']}"
                              noSelection="['':'-Choose One-']" />
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">Telco Provider</label>
                <div class="col-sm-8">
                    <g:select name="profileItems_LM_TELCOPROVIDER001"
                              class="form-control" style="width: auto"
                              from="${LookupMaster.findByCode('LM_TELCOPROVIDER001')?.values}" optionKey="key" optionValue="value"
                              value="${respondentDetail?.profileItems['PI_TELCOPROVIDER001']}"
                              noSelection="['':'-Choose One-']" />
                </div>
            </div>
