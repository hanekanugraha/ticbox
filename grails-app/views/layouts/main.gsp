                        ...
                        <li class="dropdown">
                            <g:link class="dropdown-toggle" data-toggle="dropdown" onclick="updateNotificationPeek()">
                                ...
                                <g:if test="${ticbox.UserNotification.findAllByUsernameAndIsNoticed(SecurityUtils.getSubject().getPrincipals().oneByType(String.class), false).size() > 0}">
                                    ...
                                    <g:if test="${ticbox.UserNotification.countRelevantNotificationSinceLastPeek(SecurityUtils.getSubject().getPrincipals().oneByType(String.class)).size() > 0}">
                                        <span class="badge">
                                            ${ticbox.UserNotification.countRelevantNotificationSinceLastPeek(SecurityUtils.getSubject().getPrincipals().oneByType(String.class)).size()}
                                        </span>
                                    </g:if>
                                    <g:else>
