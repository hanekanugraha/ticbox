        ...
        <td colspan="2">
            ...
            padding: 12px;">
                <div style="padding: 12px; font-size:12px">
                    ...
                    <br/><br/>
                    If you did not request a reset password for this account, don't worry – your account is still secure and no one has been given access to it.
                    <br/><br/>
                    Thanks,
                    <br/>
                    Ticbox Team
